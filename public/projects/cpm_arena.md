...
- **폰트 및 이미지 최적화**
  ...
  - Next/image를 활용하여 LCP, CLS 등을 개선함
- **실 서비스 제공**
...
<span style="color: #FF5722; font-weight: 700; text-shadow: 1px 1px 1px black">현재 일 방문자 수는 150명 정도이고, 커뮤니티에서 컴프매 아레나 도우미를 활용하여 사용하고 있습니다.</span>
...
사용자들에게 오류나 개선 사항을 접수 받아 이를 해결하고, 더 쾌적하고 원활한 이용을 위해 최적화를 하며 많은 지식 습득과 좋은 경험을 하게 되었습니다.
